                ...
                <div class="sidebar-user">
                    <div class="d-flex justify-content-center">
                        <div class="flex-shrink-0">
                            <img src="img/avatar.jpg" class="avatar img-fluid rounded me-1" alt="Charles Hall">
                        </div>
                    ...
                    <ul class="navbar-nav navbar-align">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-end" aria-labelledby="languageDropdown">
                                <a class="dropdown-item" href="#">
                                    <img src="img/us.png" alt="English" width="20" class="align-middle me-1">
                                    <span class="align-middle">English</span>
                                </a>
                                <a class="dropdown-item" href="#">
                                    <img src="img/es.png" alt="Spanish" width="20" class="align-middle me-1">
                                    <span class="align-middle">Spanish</span>
                                </a>
                                <a class="dropdown-item" href="#">
                                    <img src="img/ru.png" alt="Russian" width="20" class="align-middle me-1">
                                    <span class="align-middle">Russian</span>
                                </a>
                                <a class="dropdown-item" href="#">
                                    <img src="img/de.png" alt="German" width="20" class="align-middle me-1">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-icon pe-md-0 dropdown-toggle" href="#" data-bs-toggle="dropdown">
                                <img src="img/avatar.jpg" class="avatar img-fluid rounded" alt="Charles Hall">
                            </a>
                                                ...
                                                <div class="d-flex">
                                                    <div class="flex-shrink-0">
                                                        <div class="bg-light rounded-2">
                                                            <img class="p-2" src="img/brand-1.svg">
                                                        </div>
                                                    </div>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex">
                                                    <div class="flex-shrink-0">
                                                        <div class="bg-light rounded-2">
                                                            <img class="p-2" src="img/brand-2.svg">
                                                        </div>
                                                    </div>
                                                    <div class="flex-grow-1 ms-3">
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex">
                                                    <div class="flex-shrink-0">
                                                        <div class="bg-light rounded-2">
                                                            <img class="p-2" src="img/brand-3.svg">
                                                        </div>
                                                    </div>
                                                    <div class="flex-grow-1 ms-3">
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex">
                                                    <div class="flex-shrink-0">
                                                        <div class="bg-light rounded-2">
                                                            <img class="p-2" src="img/brand-4.svg">
                                                        </div>
                                                    </div>
                                                    <div class="flex-grow-1 ms-3">
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex">
                                                    <div class="flex-shrink-0">
                                                        <div class="bg-light rounded-2">
                                                            <img class="p-2" src="img/brand-5.svg">
                                                        </div>
                                                    </div>
                                                    <div class="flex-grow-1 ms-3">
