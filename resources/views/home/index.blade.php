...
@section('content')
            ...
            <div class="row clearfix">
                <div class="col-lg-6 col-md-12 col-sm-12 image-column">
                    <div class="image-box">
                        <div class="image-shape">
                            ...
                            <div class="shape-3" style="background-image: url({{asset('assets/img/shape-1ex.png')}});"></div>
                            <div class="shape-4" style="background-image: url({{asset('assets/img/shape-2ex.png')}});"></div>
                        </div>
                        <figure class="image"><img src="{{asset('assets/img/jmkfile/accueil/accueil-agro.fw.png')}}" alt="">
                        </figure>
                ...
                <div class="col-lg-6 col-md-12 col-sm-12 content-column">
                    <div class="content-box">
                        ...
                        <div class="text-box">
                            <p>Créateur de compétences, d’innovation et d’opportunités. Nous vous accompagnons dans
                                votre développement stratégique au quotidien. Nous opérons dans les secteurs du
                                négoce de matières premières, le conseil en développement
                                des entreprises, le conseil en études et gestion des projets, l’incubation pour les
                                organisations agricoles, l’import-export et le conseil en gestion comptable et
                                financière…</p>
                        </div>
            ...
            <div class="three-item-carousel owl-carousel owl-theme owl-nav-none">
                <div class="service-block-one block-one">
                    <div class="inner-box">
                        ...
                        <p>That they cannot foresee the pain trouble that are bound ensue equal blame belongs to
                            duty.</p>
                    </div>
                </div>
                <div class="service-block-one block-two">
                    <div class="inner-box">
                        ...
                        <div class="link"><a href="#"><span>Explore Service</span></a>
                        </div>
                        <p>Power of choice is untrammelled when nothing prevent our being all to do what we like
                            best.</p>
                    </div>
                </div>
                <div class="service-block-one block-three">
                    <div class="inner-box">
                        ...
                        <p>Obligations of business it will occur that pleasures have to repudiaters and annoyances
                            accepted.</p>
                    </div>
                </div>
                <div class="service-block-one block-one">
            ...
            <div class="growth-inner">
                <div class="row clearfix">
                    <div class="col-lg-8 col-md-12 col-sm-12 content-column">
                        <div class="content-box">
                            <figure class="image-box"><img src="{{asset('assets/img/growth-1_1.png')}}" alt=""></figure>
                            <div class="sec-title light">
                                <span class="sub-title">Our Growth</span>
                                <h2>Thinking <br>Beyond Ordinary <br>Strategies</h2>
                            </div>
                            <div class="text-box">
                                <p>The wise man therefore always holds in these <br>matters to this principle of
                                    selection.</p>
                                <a href="#" class="theme-btn btn-two"><span>Annual Report</span></a>
                            </div>
                    ...
                    <div class="col-lg-4 col-md-12 col-sm-12 inner-column">
                        <div class="growth-content">
                            <div class="growth-block-one">
                                <div class="inner-box">
                                    <h3><a href="#">Global Impact</a></h3>
                                    <p>Ever undertakes labor physic exercise except some advantage.</p>
                                    <div class="icon-box"><i class="flaticon-development"></i></div>
                                    <div class="link-box"><a href="#"><span>Read More</span></a></div>
                                </div>
                            </div>
                            <div class="growth-block-one">
                                <div class="inner-box">
                                    <h3><a href="#">Corporate Sustainability</a></h3>
                ...
                <ul class="five-item-carousel owl-carousel owl-theme owl-nav-none owl-dots-none">
                    <li>
                        <figure class="clients-logo">
                            <a href="#"><img src="{{asset('assets/img/clients-1.png')}}" alt=""></a>
                        </figure>
                    </li>
                    <li>
                        <figure class="clients-logo">
                            <a href="#"><img src="{{asset('assets/img/clients-2.png')}}" alt=""></a>
                        </figure>
                    </li>
                    <li>
                        <figure class="clients-logo">
                            <a href="#"><img src="{{asset('assets/img/clients-3.png')}}" alt=""></a>
                        </figure>
                    </li>
                    <li>
                        <figure class="clients-logo">
                            <a href="#"><img src="{{asset('assets/img/clients-4.png')}}" alt=""></a>
                        </figure>
                    </li>
                    <li>
                        <figure class="clients-logo">
                            <a href="#"><img src="{{asset('assets/img/clients-5.png')}}" alt=""></a>
                        </figure>
                    </li>
                </ul>
                <div class="more-text centred">
                    <h5>2.6k Companies &amp; Individuals Trusted  Us. <a href="#"><i class="flaticon-right-chevron"></i>View All Clients</a></h5>
                </div> 
            </div>
        </div>
    </section>
                ...
                <div class="row clearfix">
                    <div class="col-lg-4 col-md-6 col-sm-12 working-block">
                        <div class="working-block-one">
                            <div class="inner-box">
                                <div class="image-box">
                                    <figure class="image"><img src="{{asset('assets/img/working-1.jpg')}}" alt=""></figure>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 working-block">
                        <div class="working-block-one">
                            <div class="inner-box">
                                <div class="image-box">
                                    <figure class="image"><img src="{{asset('assets/img/working-2.jpg')}}" alt=""></figure>
                                    <div class="icon-box"><i class="flaticon-paper"></i></div>
                                </div>
                                <div class="lower-content">
                                    <h3>Know Client Needs</h3>
                                    <p>Pursue pleasure rational all counter consequence that extremely painful duty
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 working-block">
                        <div class="working-block-one">
                            <div class="inner-box">
                                <div class="image-box">
                                    <figure class="image"><img src="{{asset('assets/img/working-3.jpg')}}" alt=""></figure>
                                    <div class="icon-box"><i class="flaticon-analysis"></i></div>
                                </div>
                                <div class="lower-content">
                                    <h3>Market Research</h3>
                                    <p>Takes a trivial example, which ever it undertake laborios physical exercise
                                        secure other greater.</p>
                            ...
                            <div class="p-tab active-tab" id="tab-5">
                                <div class="four-item-carousel owl-carousel owl-theme">
                                    <div class="project-block-one">
                                        <div class="inner-box">
                                            <figure class="image-box"><img src="{{asset('assets/img/project-1.jpg')}}" alt="">
                                            </figure>
                                            <div class="content-inner">
                                                <div class="text-box">
                                                    <h6>Business</h6>
                                                    <h3><a href="#">Investing in Emerging
                                                            Markets</a></h3>
                                                </div>
                                                <div class="link">
                                                    <a href="#"><i
                                    ...
                                    <div class="project-block-one">
                                        <div class="inner-box">
                                            <figure class="image-box"><img src="{{asset('assets/img/project-2.jpg')}}" alt="">
                                            </figure>
                                            <div class="content-inner">
                                                <div class="text-box">
                                                    <h6>Investment</h6>
                                                    <h3><a href="#">Revisiting Your Investment
                                                            Goals</a></h3>
                                                </div>
                                                <div class="link">
                                                    <a href="#"><i
                                    ...
                                    <div class="project-block-one">
                                        <div class="inner-box">
                                            <figure class="image-box"><img src="{{asset('assets/img/project-3.jpg')}}" alt="">
                                            </figure>
                                            <div class="content-inner">
                                                <div class="text-box">
                                                    <h6>Business</h6>
                                                    <h3><a href="#">Dimensional Fund Advisors
                                                            Interview</a></h3>
                                                </div>
                                                <div class="link">
                                                    <a href="#"><i
                                    ...
                                    <div class="project-block-one">
                                        <div class="inner-box">
                                            <figure class="image-box"><img src="{{asset('assets/img/project-4.jpg')}}" alt="">
                                            </figure>
                                            <div class="content-inner">
                                                <div class="text-box">
                                                    <h6>Financial Plan</h6>
                                                    <h3><a href="#">Interested in Giving Back
                                                            this year</a></h3>
                                                </div>
                                                <div class="link">
                                                    <a href="#"><i
                                    ...
                                    <div class="project-block-one">
                                        <div class="inner-box">
                                            <figure class="image-box"><img src="img/project-4.jpg" alt="">
                                            </figure>
                                            <div class="content-inner">
                                                <div class="text-box">
                                                    <h6>Financial Plan</h6>
                                                    <h3><a href="project-details.html">Interested in Giving Back
                                                            this year</a></h3>
                                                </div>
                                                <div class="link">
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 news-block">
                    <div class="news-block-one wow fadeInUp animated" data-wow-delay="00ms"
                        ...
                        <div class="inner-box">
                            ...
                            <div class="image-box">
                                <figure class="image">
                                    <a href="#"><img src="{{asset('assets/img/news-1.jpg')}}" alt=""></a>
                                </figure>
                                <div class="view-btn"><a href="{{asset('assets/img/news-1.jpg')}}" class="lightbox-image"
                                        data-fancybox="gallery"><i class="flaticon-zoom-in"></i></a></div>
                            </div>
                            <div class="lower-box">
                                <h3><a href="#">Revisiting Your Investment &amp; Distribution
                                        Goals</a></h3>
                                <div class="link"><a href="#"><span>Explore More</span></a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 news-block">
                    <div class="news-block-one wow fadeInUp animated" data-wow-delay="300ms"
                        ...
                        <div class="inner-box">
                            ...
                            <div class="image-box">
                                <figure class="image">
                                    <a href="#"><img src="{{asset('assets/img/news-2.jpg')}}" alt=""></a>
                                </figure>
                                <div class="view-btn"><a href="{{asset('assets/img/news-2.jpg')}}" class="lightbox-image"
                                        data-fancybox="gallery"><i class="flaticon-zoom-in"></i></a></div>
                            </div>
                            <div class="lower-box">
                                <h3><a href="#">Dimensional Fund Advisors Interview with
                                        Director</a></h3>
                                <div class="link"><a href="#"><span>Explore More</span></a>
                                </div>
                            </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 news-block">
                    <div class="news-block-one wow fadeInUp animated" data-wow-delay="600ms"
                        ...
                        <div class="inner-box">
                            ...
                            <div class="image-box">
                                <figure class="image">
                                    <a href="blog-details.html"><img src="{{asset('assets/img/news-3.jpg')}}" alt=""></a>
                                </figure>
                                <div class="view-btn"><a href="{{asset('assets/img/news-3.jpg')}}" class="lightbox-image"
                                        data-fancybox="gallery"><i class="flaticon-zoom-in"></i></a></div>
                            </div>
                            <div class="lower-box">
                                <h3><a href="#">Interested in Giving Back this year? Here are some
                                        tips</a></h3>
                                <div class="link"><a href="#"><span>Explore More</span></a>
                                </div>
                            </div>
    ...
    <!-- news-section end -->
    <!-- testimonial-section -->
    <section class="testimonial-section sec-pad" style="margin-bottom: 100px;">
                            ...
                            <div class="bxslider">
                                <div class="slider-content">
                                    <div class="testimonial-block-one">
                                        <figure class="thumb-box"><img src="{{asset('assets/img/testimonial-1.png')}}" alt="">
                                        </figure>
                                        <div class="inner-box">
                                            <div class="icon-box"><i class="flaticon-quote"></i></div>
                                            <h4>Great Experience!</h4>
                                            <p>I have been financially advised by counsolve investment Planners
                                                since 2022 I have had a very good experience. The sound financial
                                                advice they gave me helped me to achieve.</p>
                                            <h3>Nathan Felix</h3>
