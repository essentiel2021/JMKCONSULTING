            ...
            <div class="row clearfix">
                <div class="col-lg-6 col-md-12 col-sm-12 image-column">
                    <div class="image-box">
                        ...
                        <figure class="image"><img src="{{asset('assets/img/jmkfile/accueil/accueil-agro.fw.png')}}" alt=""></figure>
                ...
                <div class="col-lg-6 col-md-12 col-sm-12 content-column">
                    <div class="content-box">
                        ...
                        <div class="text-box">
                            <p>Créateur de compétences, d’innovation et d’opportunités. Nous vous accompagnons dans votre développement stratégique au quotidien. Nous opérons dans les secteurs du négoce de matières premières, le conseil en développement des entreprises, le conseil en études et gestion des projets, l’incubation pour les organisations agricoles, l’import-export et le conseil en gestion comptable et financière…</p>
                        </div>
        ...
        <div class="auto-container">
            ...
            <div class="clients-section">
                <ul class="five-item-carousel owl-carousel owl-theme owl-nav-none owl-dots-none">
                    <li><figure class="clients-logo"><a href="index_1.html"><img src="{{asset('assets/img/clients-1.png')}}" alt=""></a></figure></li>
                    <li><figure class="clients-logo"><a href="index_1.html"><img src="{{asset('assets/img/clients-2.png')}}" alt=""></a></figure></li>
                    <li><figure class="clients-logo"><a href="index_1.html"><img src="{{asset('assets/img/clients-3.png')}}" alt=""></a></figure></li>
                    <li><figure class="clients-logo"><a href="index_1.html"><img src="{{asset('assets/img/clients-4.png')}}" alt=""></a></figure></li>
                    <li><figure class="clients-logo"><a href="index_1.html"><img src="{{asset('assets/img/clients-5.png')}}" alt=""></a></figure></li>
                </ul>
                            ...
                            <div class="p-tab active-tab" id="tab-5">
                                <div class="four-item-carousel owl-carousel owl-theme">
                                    <div class="project-block-one">
                                        <div class="inner-box">
                                            <figure class="image-box"><img src="{{asset('assets/img/project-1.jpg')}}" alt=""></figure>
                                    ...
                                    <div class="project-block-one">
                                        <div class="inner-box">
                                            <figure class="image-box"><img src="{{asset('assets/img/project-2.jpg')}}" alt=""></figure>
                                            <div class="content-inner">
                                                <div class="text-box">
                                                    <h6>Investment</h6>
                                    ...
                                    <div class="project-block-one">
                                        <div class="inner-box">
                                            <figure class="image-box"><img src="{{asset('assets/img/project-3.jpg')}}" alt=""></figure>
                                            <div class="content-inner">
                                                <div class="text-box">
                                                    <h6>Business</h6>
                                                    <h3><a href="project-details.html">Dimensional Fund Advisors Interview</a></h3>
                                                </div>
                                                <div class="link">
                                                    <a href="project-details.html"><i class="flaticon-diagonal-arrow"></i></a>
                                                </div>
                                    ...
                                    <div class="project-block-one">
                                        <div class="inner-box">
                                            <figure class="image-box"><img src="{{asset('assets/img/project-4.jpg')}}" alt=""></figure>
                                            <div class="content-inner">
                                                <div class="text-box">
                                                    <h6>Financial Plan</h6>
                                                    <h3><a href="project-details.html">Interested in Giving Back this year</a></h3>
                                                </div>
                                                <div class="link">
                                                    <a href="project-details.html"><i class="flaticon-diagonal-arrow"></i></a>
                                                </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 news-block">
                    <div class="news-block-one wow fadeInUp animated" data-wow-delay="00ms" data-wow-duration="1500ms">
                        <div class="inner-box">
                            ...
                            <div class="image-box">
                                <figure class="image"><a href="blog-details.html"><img src="{{asset('assets/img/news-1.jpg')}}" alt=""></a></figure>
                                <div class="view-btn"><a href="{{asset('assets/img/news-1.jpg')}}" class="lightbox-image" data-fancybox="gallery"><i class="flaticon-zoom-in"></i></a></div>
                            </div>
                            <div class="lower-box">
                                <h3><a href="blog-details.html">Revisiting Your Investment &amp; Distribution Goals</a></h3>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 news-block">
                    <div class="news-block-one wow fadeInUp animated" data-wow-delay="300ms" data-wow-duration="1500ms">
                        <div class="inner-box">
                            ...
                            <div class="image-box">
                                <figure class="image"><a href="blog-details.html"><img src="{{asset('assets/img/news-2.jpg')}}" alt=""></a></figure>
                                <div class="view-btn"><a href="{{asset('assets/img/news-2.jpg')}}" class="lightbox-image" data-fancybox="gallery"><i class="flaticon-zoom-in"></i></a></div>
                            </div>
                            <div class="lower-box">
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 news-block">
                    <div class="news-block-one wow fadeInUp animated" data-wow-delay="600ms" data-wow-duration="1500ms">
                        <div class="inner-box">
                            ...
                            <div class="image-box">
                                <figure class="image"><a href="blog-details.html"><img src="{{asset('assets/img/news-3.jpg')}}" alt=""></a></figure>
                                <div class="view-btn"><a href="{{asset('assets/img/news-3.jpg')}}" class="lightbox-image" data-fancybox="gallery"><i class="flaticon-zoom-in"></i></a></div>
                            </div>
                            <div class="lower-box">
                                <h3><a href="blog-details.html">Interested in Giving Back this year? Here are some tips</a></h3>
                                <div class="link"><a href="blog-details.html"><span>Explore More</span></a></div>
                            </div>
                        </div>
                    </div>
